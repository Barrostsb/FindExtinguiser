...
public class frmLogin extends javax.swing.JFrame {
	...
	/**
	 * Controller btnEnterHandler responsável pela ação de autenticação
	 * @author Thiago Henrique Poiani
	 */
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				if (Session.getId() != 0) {
					...
					JOptionPane.showMessageDialog(null, "Usuário ou senha incorretos.", "Autenticação", JOptionPane.INFORMATION_MESSAGE);
				}
	...
	/**
	 * Controller btnLimparHandler responsável pela ação de autenticação
	 * @author Thiago Henrique Poiani
	 */
