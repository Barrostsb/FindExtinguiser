...
public class frmPrincipal extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jpRelatorio.setBorder(javax.swing.BorderFactory.createTitledBorder("Relatório"));
		...
		jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Manutenção/Inspeção"));
		...
		smCadastrarManutInsp.setText("Manutenções/Inspeções");
		...
		smGerenciarManutInsp.setText("Manutenções/Inspeções");
		...
		smRelatorioEmitir.setText("Emitir Relatório");
		...
		//Cadastrar manutenções e inspeções
		...
		//Gerenciar manutenções e inspeções
